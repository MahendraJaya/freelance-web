...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('order', function (Blueprint $table) {
            ...
            ->onUpdate('CASCADE')
            ->onDelete('CASCADE');
            $table->foreign('service_id', 'fk_order_service_to_service')
            ->references('id')
            ->on('service')
            ->onUpdate('CASCADE')
            ->onDelete('CASCADE');
            $table->foreign('order_status_id', 'fk_order_order_status_to_order')
            ->references('id')
            ->on('order_status')
            ->onUpdate('CASCADE')
            ->onDelete('CASCADE');
    ...
    public function down(): void
    {
        Schema::table('order', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_order_order_status_to_order');
        });
    }
};
