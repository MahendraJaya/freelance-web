                        ...
                        <form action="{{ route('member.service.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit"
                                                ...
                                                <option value="16">16 Revisi</option>
                                                <option value="32">32 Revisi</option>
                                            </select>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan 1" type="text" name="advantage-user[]"
                                                value="{{ old('advantage-user[]') }}" required id="advantage-user"
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    <a type="button" href="{{ route('member.service.index') }}"
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addAdvantagesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan" type="text" name="advantage-user[]" id="advantage-user" required autocomplete="advantage-user"  class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
    ...
    <script type="text/javascript">
        ...
        $("#addTaglineRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Catatan" type="text" name="tagline[]" id="tagline" required autocomplete="tagline" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
