        ...
        <div class="m-auto text-center h-auto">
            <svg class="mb-6 w-full" width="490" height="350" viewBox="0 0 490 350" fill="none"
                ...
                <g filter="url(#filter0_d)">
                    <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="375" y="125" width="100"
                        height="100">
                ...
                <g filter="url(#filter1_d)">
                    <mask id="mask1" mask-type="alpha" maskUnits="userSpaceOnUse" x="15" y="126" width="100"
                        height="100">
